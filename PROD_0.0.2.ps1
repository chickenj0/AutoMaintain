...
Install-Module PSWindowsUpdate -Force -AllowClobber -Scope CurrentUser -PassThru 
...
Get-WindowsUpdate -Install -AcceptAll -Wait 
...
winget install adobe.acrobat.reader.64-bit -Wait 
...
winget install apple.itunes --Wait 
...
Start-Process -FilePath "cleanmgr.exe" -ArgumentList "/sagerun:1" -Wait -NoNewWindow -Verbose -PassThru 
